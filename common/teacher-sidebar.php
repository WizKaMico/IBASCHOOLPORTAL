		...
		<nav id="sidebarMenu" class="">
			<div class="col-xl-2 col-lg-3 col-md-4 sidebar position-fixed border-right">
        		<div class="sidebar-header">
					<a class="nav-link text-white" href="../teacher/index.php?view=DASHBOARD">
				...
				<ul class="nav flex-column">
					<li class="nav-item">
						<a class="nav-link" href="../teacher/index.php?view=PERSONAL">
						<span data-feather="file"></span>
						<i class="fa fa-user mr-2" aria-hidden="true"></i> Personal Profile
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../teacher/index.php?view=CLASS">
						<span data-feather="file"></span>
						<i class="fa fa-address-book mr-2" aria-hidden="true"></i> Classes
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../teacher/index.php?view=GRADES">
						<span data-feather="shopping-cart"></span>
						<i class="fa fa-file-text mr-2" aria-hidden="true"></i> Grades
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../teacher/index.php?view=SETTING">
