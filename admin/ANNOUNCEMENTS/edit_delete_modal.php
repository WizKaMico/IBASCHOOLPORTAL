...
<!-- image -->
<div class="modal fade" id="image_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="modal-body">
			<div class="container-fluid">
			<form method="POST" action="image_edit.php">
				<input type="hidden" class="form-control" name="id" value="<?php echo $row['id']; ?>">
				<div class="row form-group">
					<div class="col-sm-2">
							<label>Current Photo</label>
					</div>		
					<img src="<?php echo $row['photo']?>" height="120" width="150" />
...
<div class="modal fade" id="delete_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">	
            	<p class="text-center">Are you sure you want to Delete Announcement</p>
