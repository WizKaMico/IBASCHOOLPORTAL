        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit.php">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="date" class="form-control" name="date_from" value="<?php echo $row['date_from']; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="date" class="form-control" name="date_to" value="<?php echo $row['date_to']; ?>">
					</div>
				</div>
					...
					<div class="col-sm-10">
						<select class="form-control" name="status">
							<option value="<?php echo $row['status']; ?>"><?php echo $row['status']; ?> (CURRENTLY)</option>
...
<div class="modal fade" id="delete_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <center><h4 class="modal-title" id="myModalLabel">Delete Enrollment</h4></center>
            </div>
            <div class="modal-body">	
