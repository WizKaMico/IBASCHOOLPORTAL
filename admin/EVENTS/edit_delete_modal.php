        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit.php">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="date_from" value="<?php echo $row['date_from']; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="date_to" value="<?php echo $row['date_to']; ?>">
					</div>
				</div>
            </div> 
			</div>
...
<div class="modal fade" id="delete_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">	
            	<p class="text-center">Are you sure you want to Delete Event</p>
