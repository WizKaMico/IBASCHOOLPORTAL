...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="row">
				<a href="#addnew" data-toggle="modal" class="btn btn-primary" style="background-color:#2c3e50; border-color:#2c3e50;"><span class="glyphicon glyphicon-plus"></span>ADD EVENT</a>
			</div>
			<div class="height10">
			</div>
			<div class="row">
