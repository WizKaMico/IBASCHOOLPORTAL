				...
				<table id="myTable" class="table table-bordered table-striped">
					...
					<tbody>
						<?php
							...
							$sql = "SELECT * FROM login LEFT JOIN teacher_assigned ON login.user_id = teacher_assigned.user_id LEFT JOIN class ON teacher_assigned.class_id = class.id LEFT JOIN year ON class.year_id = year.id LEFT JOIN class_schedule ON class.id = class_schedule.class_id WHERE login.role = 'teacher' AND login.user_id = '$user_id'";
