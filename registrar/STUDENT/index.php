...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="row">
				<a href="#addnew" data-toggle="modal" class="btn btn-primary" style="background-color:#2c3e50; border-color:#2c3e50;"><span class="glyphicon glyphicon-plus"></span>ENCODE</a>
				...
				<table id="myTable" class="table table-bordered table-striped">
					...
					<tbody>
						<?php
							...
							$sql = "SELECT *,student_info.id as STUDIN, login.id as LOGID FROM `student_info` LEFT JOIN login ON student_info.user_id = login.user_id LEFT JOIN student_assigned ON login.user_id = student_assigned.user_id WHERE role = 'student'";
